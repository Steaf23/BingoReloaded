...
// @EventHandlers ========================================================================
    ...
    public void handlePlayerRespawn(final PlayerRespawnEvent event) {
        ...
        boolean correctRespawnPoint = !event.isBedSpawn() && !event.isAnchorSpawn() && event.getPlayer().getBedSpawnLocation() == null;
        if (correctRespawnPoint && playerSpawnPoints.containsKey(player.getId())) {
            ...
            event.getPlayer().setBedSpawnLocation(newSpawnLocation, true);
        }
    }
