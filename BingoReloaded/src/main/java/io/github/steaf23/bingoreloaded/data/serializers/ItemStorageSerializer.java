...
{
    @Override
    public void toDataStorage(@NotNull DataStorage storage, SerializableItem value) {
    ...
    public @Nullable SerializableItem fromDataStorage(@NotNull DataStorage storage) {
        return new SerializableItem(storage.getInt("slot", 0), storage.getItemStack("slot"));
    }
}
