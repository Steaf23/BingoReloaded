...
public abstract class MenuInventory
{
    ...
    public final void handleClick(final InventoryClickEvent event)
    {
        ...
        if (event.getInventory() == inventory)
        {
            ...
            {
                onItemClicked(event, event.getSlot(), (Player)event.getWhoClicked(), event.getClick());
            }
        }
    }
    ...
    protected void addItems(MenuItem... options)
    {
     ...
     */
    protected void addItem(MenuItem option)
    {
