...
public final class ColorPickerMenuNew extends BasicMenu
{
    ...
    private ColorPickerMenuNew(MenuManager manager, String title, Consumer<ChatColor> result) {
    ...
    public static void createAndOpen(MenuManager manager, String title, Consumer<ChatColor> result, Player player) {
        new ColorPickerMenuNew(manager, title, result).open(player);
    }
