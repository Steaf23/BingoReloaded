...
//        ResourceKey<LevelStem> actualDimension = ResourceKey.create(Registries.LEVEL_STEM, ResourceLocation.fromNamespaceAndPath("bingoreloaded", "bingo"));
        ...
        if (console.options.has("forceUpgrade")) {
            net.minecraft.server.Main.forceUpgrade(levelStorageAccess, console.getWorldData(), DataFixers.getDataFixer(), console.options.has("eraseCache"), () -> true, registryAccess, console.options.has("recreateRegionFiles"));
        }
