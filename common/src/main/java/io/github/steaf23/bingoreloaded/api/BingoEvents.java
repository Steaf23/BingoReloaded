...
public class BingoEvents {
	public record SessionEvent(BingoSession session){}
	public record PlayerEvent(BingoSession session, PlayerHandle player){}

	public record TaskProgressCompletedEvent(BingoSession session, GameTask task) {}
	public record TeamParticipantEvent(BingoSession session, BingoParticipant participant, @Nullable BingoTeam team, boolean autoTeam){}
	...
	public record StatisticCompleted(BingoSession session, StatisticHandlePaper statistic, BingoParticipant participant){}
