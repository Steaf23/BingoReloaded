...
public class MenuItemGroup
{
    ...
    public boolean handleClick(InventoryMenu menu, PlayerHandle player, int clickedSlot, ClickType clickType) {
        for (ItemTemplate item : new ArrayList<>(items)) {
            ...
            if (itemSlot == clickedSlot) {
                ...
                menu.getInventory().setItem(itemSlot, item.buildItem());
            }
        }
        return true;
    }
