...
public record BingoStatistic(@NotNull Statistic stat, @Nullable EntityType entityType, @Nullable Material materialType)
{
    ...
    private static @Nullable ItemType getMaterialFromString(@Nullable String type) {
        if (type != null && !type.isEmpty()) {
    ...
    public static @NotNull ItemType getMaterial(BingoStatistic statistic)
    {
    ...
    private static ItemType rootStatMaterial(BingoStatistic statistic)
    {
