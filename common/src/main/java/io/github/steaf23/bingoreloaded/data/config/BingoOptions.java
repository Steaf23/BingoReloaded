...
public class BingoOptions {
	...
	public static final ConfigurationOption<Double> ENDLESS_PEARL_COOLDOWN = new DoubleOption("endlessPearl.cooldown");
	public static final ConfigurationOption<Double> TEAM_TELEPORTER_COOLDOWN = new DoubleOption("teamTeleporter.cooldown");
