...
{
    public SingularGameManager(@NotNull MinecraftExtension extension, BingoConfigurationData config, MenuBoard menuBoard, HUDRegistry hudRegistry) {
    ...
    private WorldGroup createWorldGroupFromExistingWorlds() {
        ...
        WorldHandle overworld = Bukkit.getWorld(defaultWorldName);
        WorldHandle nether = Bukkit.getWorld(defaultWorldName + "_nether");
        WorldHandle theEnd = Bukkit.getWorld(defaultWorldName + "_the_end");
