...
public enum BingoMessage
{
    ...
    TELEPORT_TO_START("game.player.teleport_to_start"),
    ...
    ITEM_TEAM_TELEPORTER_NAME("items.team_teleporter.name"),
    ITEM_TEAM_TELEPORTER_DESC("items.team_teleporter.desc"),
