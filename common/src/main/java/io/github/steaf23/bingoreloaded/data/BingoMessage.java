...
public enum BingoMessage
{
    ...
    EFFECTS_ITEM_MAGNET("menu.effects.item_magnet"),
    EFFECTS_VEIN_MINER("menu.effects.vein_miner"),
    ...
    TEAM_TELEPORTER_TITLE("menu.team_teleporter.title"),
    TELEPORT_TO_TEAM("menu.team_teleporter.teleport_to_team"),
    TELEPORT_TO_SPAWN("menu.team_teleporter.teleport_to_spawn"),
    ITEM_CARD_NAME("items.card.name"),
    ITEM_CARD_DESC("items.card.desc"),
    ITEM_WAND_NAME("items.wand.name"),
    ITEM_WAND_DESC("items.wand.desc"),
    ITEM_VOTE_NAME("items.vote.name"),
    ITEM_VOTE_DESC("items.vote.desc"),
    ITEM_TEAM_NAME("items.team.name"),
    ITEM_TEAM_DESC("items.team.desc"),
    ITEM_POUCH_NAME("items.pouch.name"),
    ITEM_POUCH_DESC("items.pouch.desc"),
    ITEM_ENDLESS_PEARL_NAME("items.pearl.name"),
    ITEM_ENDLESS_PEARL_DESC("items.pearl.desc"),
    ITEM_TEAM_BOX_NAME("items.team_box.name"),
    ITEM_TEAM_BOX_DESC("items.team_box.desc"),
