...
public record TeleportationGrid(Point cellSize, String finishedCommand, Point center, Point size, boolean skipOceanBiomes) {
	...
	public record Point(int x, int z) {
		public static final DataStorageSerializer<Point> SERIALIZER = DataStorageSerializer.of(
				(storage, value) -> {
	...
	public static final DataStorageSerializer<TeleportationGrid> SERIALIZER = DataStorageSerializer.of(
			(storage, value) -> {
